...
from agent.travel_planning_agent import travel_planning_agent
    ...
    with st.container():
        if message["role"] == "user":
            ...
            <div class="chat-message user">
                <div class="content">
                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed={st.session_state}" class="avatar" />
                    <div class="message">
                        {message["content"]}
...
async def main():
    ...
    if st.session_state.processing_message:
        ...
        # Process the mes the age asynchronously
            ...
            try:
                ...
                async for event in result.stream_events():
                    if event.type == "raw_response_event" and isinstance(event.data, ResponseTextDeltaEvent):
                        ...
                        message_placeholder.markdown(format_agent_response(response_content))
